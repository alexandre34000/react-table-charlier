(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/slicedToArray'), require('react')) :
    typeof define === 'function' && define.amd ? define(['@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/slicedToArray', 'react'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["react-table-charlier"] = factory(global._defineProperty, global._toConsumableArray, global._slicedToArray, global.React));
})(this, (function (_defineProperty, _toConsumableArray, _slicedToArray, React) { 'use strict';
    ...
    var TableHeader = function TableHeader(props) {
      return Object.entries(props.eltHead).map(function (_ref) {
        ...
        return /*#__PURE__*/React__default["default"].createElement("th", {
          ...
          tabIndex: "1"
        }, v), /*#__PURE__*/React__default["default"].createElement("span", {
    ...
    var toSearchByValue = function toSearchByValue(arr, value, keyName) {
      ...
      var arrayFiltered = _toConsumableArray__default["default"](arr).filter(function (el) {
    ...
    var buildHeaderElement = function buildHeaderElement(bodyEl, headEl) {
      if (Object.keys(headEl).length > 0) {
        ...
        return Object.keys(bodyEl[0]).reduce(function (acc, key) {
          return _objectSpread(_objectSpread({}, acc), {}, _defineProperty__default["default"]({}, key, key));
        }, {});
      }
    };
    /**
    ...
    var TableComponent = function TableComponent(props) {
      ...
      var _useState = React.useState(valueOptions.nbRows[0]),
      ...
      var _useState9 = React.useState(Object.keys(listBody[0])[0]),
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      })), /*#__PURE__*/React__default["default"].createElement("span", null, "entries")), /*#__PURE__*/React__default["default"].createElement("div", {
        className: "component-table__content-head_headers"
      }, /*#__PURE__*/React__default["default"].createElement("label", {
        htmlFor: "search"
      }, " Search : ", columnName), /*#__PURE__*/React__default["default"].createElement("input", {
        id: "search",
        type: "search",
      ...
      }, /*#__PURE__*/React__default["default"].createElement("tr", null, /*#__PURE__*/React__default["default"].createElement(TableHeader, {
        eltHead: valueOptions.headElements,
        handleClickHeader: handleClickHeader,
        handleClickSorted: handleClickSorted,
        currentColumn: columnName
      }))), !isError ? /*#__PURE__*/React__default["default"].createElement("tbody", null, listByPage.map(function (el, i) {
        ...
        colSpan: "100%"
      }, "No data found"))))), /*#__PURE__*/React__default["default"].createElement("div", {
        className: "component-table__content-footer",
        role: "navigation",
        onClick: handleChangePage
      }, /*#__PURE__*/React__default["default"].createElement("p", {
        className: "table-footer__counter-items"
      }, currentPage * sizeOfList > list.length ? list.length : currentPage * sizeOfList, "/ ", list.length, " "), /*#__PURE__*/React__default["default"].createElement("button", {
        className: "table-footer__button",
        "data-value": "prev",
        disabled: currentPage === 1
      }, "Prev"), _toConsumableArray__default["default"](Array(nbOfPages)).map(function (el, i) {
